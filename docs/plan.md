...
- **Free tier limits:**
  ...
  - Free TinyWall event: 100 uploads, 7-day retention, live wall included, no custom branding, no email/SMS delivery, no bulk export.
  - Note (April 2026 iteration): Kululu expanded its free tier from 50 to 500 photos in 2026 per `docs/research/iteration-2026-04.md`. We are deliberately holding at 100. Rationale: cost-to-serve scales linearly with retained photos; the no-app guest flow plus the booth-plus-wall bundle is our wedge, not "biggest free cap". Revisit at month 6 if conversion data shows guests who hit 100 are bouncing rather than upgrading.
  - Still crushes LiveShareNow (10 newest posts) per `docs/research/competitors.md`.

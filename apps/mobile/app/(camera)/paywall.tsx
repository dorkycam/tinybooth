  ...
  return (
    <View
      style={[
        styles.card,
        {
          ...
          borderColor: isHighlighted ? theme.colors.coral : theme.colors.hairline,
    ...
    >
      <View style={styles.cardHeader}>
        ...
        {isHighlighted ? (
          <Text style={[styles.cardBadge, { color: '#FFFFFF', backgroundColor: theme.colors.coral }]}>
            BEST VALUE
          </Text>
        ) : null}
      </View>
      ...
      <View style={styles.featureList}>
        {features.map((f) => (
          <View key={f} style={styles.featureRow}>
            <Text style={[styles.featureCheck, { color: theme.colors.mint }]}>{'\u2713'}</Text>
